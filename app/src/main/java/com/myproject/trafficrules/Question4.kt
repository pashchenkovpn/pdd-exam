...
import com.myproject.trafficrules.databinding.FragmentQuestion4Binding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            when (checkedRadioButtonID) {
                radiobutton1.id -> view.findNavController().navigate(R.id.action_question4_to_q4correct)
                radiobutton2.id -> {
                    viewModel.increaseCorrectAnswers()
                    view.findNavController().navigate(R.id.action_question4_to_question5)
                }
                radiobutton3.id -> view.findNavController().navigate(R.id.action_question4_to_q4correct)
                radiobutton4.id -> view.findNavController().navigate(R.id.action_question4_to_q4correct)
            }
        }
    }
